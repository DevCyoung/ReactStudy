...
export default function StaticRoutingPage(): JSX.Element {
    ...
    const { data, refetch } = useQuery<Pick<IQuery, "fetchBoards">, 
        IQueryFetchBoardArgs>(FETCH_BOARDS);
    
    const { data :dataBoardCount } = useQuery<Pick<IQuery, "fetchBoardsCount">, 
        IQueryFetchBoardArgs>(FETCH_BOARD_COUNT);
    ...
    const onClickNumber = (event: MouseEvent<HTMLSpanElement> ): void => {
        ...
        console.log(`number ${dataBoardCount}`);
